...
const Generate = (props: Props) => {
  ...
  const [additionalDetails, setAddionalDetails] = useState("");
  ...
  const [syle, setStyle] = useState<ThumbnailStyle>("Bold & Graphic");
  ...
  const fetchThumbnail = async () => {
    if (id){
        ...
        setAddionalDetails(thumbnail.user_prompt);
        setTitle(thumbnail.title);
        setColorSchemeId(thumbnail.colorSchemeId);
                ...
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      maxLength={100}
                      className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 
                      focus:ring-pink-500"
                      placeholder="E.g, 10 tips for Marketing ADS"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setAddionalDetails(e.target.value)}
                      rows={3}
                      placeholder="Add any specific elements, mood or style preferences."
                      className="w-full px-4 py-3 rounded-lg border border-white/12 bg-white/6 text-zinc-100
