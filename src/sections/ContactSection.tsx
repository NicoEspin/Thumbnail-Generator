...
export default function ContactSection() {
  ...
  return (
    <div className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        text1={t("contact.titleSmall")}
        text2={t("contact.titleMain")}
        text3={t("contact.subtitle")}
      />
      ...
      >
        ...
        >
          <p className="mb-2 font-medium">{t("contact.form.nameLabel")}</p>
        ...
        >
          <p className="mb-2 font-medium">{t("contact.form.emailLabel")}</p>
          <div className="flex items-center pl-3 rounded-lg border border-slate-700 focus-within:border-pink-500">
        ...
        >
          <p className="mb-2 font-medium">{t("contact.form.messageLabel")}</p>
          <textarea
            name="message"
            rows={8}
